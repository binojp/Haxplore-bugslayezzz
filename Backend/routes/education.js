...
const FALLBACK_QUIZZES = {
  ...
  "environmental-impact": [
    {
      question: "What percentage of global e-waste is currently properly recycled?",
      options: ["17%", "50%", "80%", "100%"],
      correctAnswer: 0,
      explanation: "Currently, only about 17% of e-waste is documented as properly collected and recycled."
    }
  ]
};
