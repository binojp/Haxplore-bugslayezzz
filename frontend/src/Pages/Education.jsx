      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Learn about proper e-waste disposal, earn rewards, and make a real environmental impact
          </p>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">Take AI-generated quizzes and earn bonus points!</p>
              </div>
            </div>
            <button
              onClick={() => handleStartQuiz("battery-disposal")}
              className="px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-bold rounded-xl shadow-lg shadow-emerald-500/30 hover:shadow-emerald-500/50 hover:-translate-y-1 transition-all"
            >
              Start Quiz
            </button>
          </div>
