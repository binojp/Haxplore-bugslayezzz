      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20">
        ...
        <div className="text-center max-w-4xl mx-auto mb-24">
          ...
          <h1 className="text-6xl md:text-8xl font-black mb-8 leading-tight tracking-tight animate-fade-in-up" style={{ animationDelay: "100ms" }}>
            Refining <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-teal-400 to-cyan-400">E-Waste</span> <br />
            For A Better Future.
          </h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-32">
          <StatCard value="12.5 T" label="E-Waste Saved" delay={400} />
          <StatCard value="45 K" label="Green Credits" delay={500} />
          <StatCard value="850 +" label="Active Recyclers" delay={600} />
          <StatCard value="120" label="Smart Bins" delay={700} />
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <FeatureCard 
            ...
            description="Instantly identify electronics, assess condition, and estimate value with our advanced Gemini-powered scanner."
            delay={800}
          />
          <FeatureCard 
            icon={MapPin} 
            title="Smart Locator" 
            description="Find the nearest specific e-waste bins. Filter by battery, mobile, or laptop disposal points instantly."
            delay={900}
          />
          <FeatureCard 
            icon={Award} 
